...
namespace JotaroMod.Survivors.Jotaro
{
    public static class JotaroConfig
    {
        ...
        public static void Init()
        {
            ...
            //healthGrowth = Config.BindAndOptions("02 - Stats", "healthGrowth", 48f);
            baseRegen = Config.BindAndOptions("02 - Stats", "baseRegen", 1.5f);
            //regenGrowth = Config.BindAndOptions("02 - Stats", "regenGrowth", 0.3f);
            baseArmor = Config.BindAndOptions("02 - Stats", "baseArmor", 20f);
            //armorGrowth = Config.BindAndOptions("02 - Stats", "armorGrowth", 0f);
            baseDamage = Config.BindAndOptions("02 - Stats", "baseDamage", 12f);
            //damageGrowth = Config.BindAndOptions("02 - Stats", "damageGrowth", 2.4f);
            //baseCrit = Config.BindAndOptions("02 - Stats", "baseCrit", 1f);
