...
namespace JotaroMod.Survivors.Jotaro
{
    public static class JotaroConfig
    {
        ...
        {
            emoteButton = Config.BindAndOptions("Emote", "YareYare", new KeyboardShortcut(UnityEngine.KeyCode.None));

            //ModSettingsManager.AddOption(new KeyBindOption(emoteButton));
