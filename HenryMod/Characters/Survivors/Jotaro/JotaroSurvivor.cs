...
using JotaroMod.Modules.Characters;
...
{
    public class JotaroSurvivor : SurvivorBase<JotaroSurvivor>
    {
        ...
        public const string HENRY_PREFIX = JotaroPlugin.DEVELOPER_PREFIX + "_JOTARO_";
        ...
        public override UnlockableDef characterUnlockableDef => JotaroUnlockables.characterUnlockableDef;
        
        public override ItemDisplaysBase itemDisplays => new JotaroItemDisplays();
        ...
        public override void InitializeCharacter()
        {
            ...
            JotaroAssets.Init(assetBundle);
            JotaroBuffs.Init(assetBundle);
        ...
        private void AdditionalBodySetup()
        {
            ...
            bodyPrefab.AddComponent<StarPlatinum>();

            displayPrefab.AddComponent<StarPlatinum>();
        }
        ...
        private void AddPrimarySkills()
        {
           ...
           (
               "JotaroPunch",
               HENRY_PREFIX + "PRIMARY_PUNCH_NAME",
               HENRY_PREFIX + "PRIMARY_PUNCH_DESCRIPTION",
        ...
        private void AddSecondarySkills()
        {
            ...
            {
                skillName = "JotaroStarFinger",
                skillNameToken = HENRY_PREFIX + "SECONDARY_FINGER_NAME",
                skillDescriptionToken = HENRY_PREFIX + "SECONDARY_FINGER_DESCRIPTION",
                keywordTokens = new string[] { "KEYWORD_STUNNING" },
                skillIcon = assetBundle.LoadAsset<Sprite>("texSecondaryIcon2"),

                activationState = new EntityStates.SerializableEntityStateType(typeof(StarFinger)),
                activationStateMachineName = "Weapon",
                interruptPriority = EntityStates.InterruptPriority.PrioritySkill,
        ...
        private void AddSpecialSkills()
        {
            ...
            {
                skillName = "JotaroStopTime",
                skillNameToken = HENRY_PREFIX + "SPECIAL_ZAWARUDO_NAME",
                skillDescriptionToken = HENRY_PREFIX + "SPECIAL_ZAWARUDO_DESCRIPTION",
                skillIcon = assetBundle.LoadAsset<Sprite>("texSpecialIcon"),

                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.StopTime)),
        ...
        public override void InitializeSkins()
        {
            ...
            SkinDef defaultSkin = Skins.CreateSkinDef("DEFAULT_SKIN",
                assetBundle.LoadAsset<Sprite>("texJotaroIcon"),
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            JotaroAI.Init(bodyPrefab, masterName);
        ...
        void Emotes()
        {
            ...
            {
                orig();
                EmotesAPI.CustomEmotesAPI.ImportArmature(bodyPrefab, JotaroAssets.emotePrefab);
            };
        }
        ...
        private void RecalculateStatsAPI_GetStatCoefficients(CharacterBody sender, R2API.RecalculateStatsAPI.StatHookEventArgs args)
        {
            ...
            if (sender.HasBuff(JotaroBuffs.armorBuff))
            {
                args.armorAdd += 300;
            }
        }
